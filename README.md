...
```javascript
// Basic Information
valentineName: "Sarah"                    // Your Valentine's name
pageTitle: "Vill du vara min Valentine? 💝" // Browser tab title
...
questions: {
    first: {
        text: "Älskar du mig?",                   // First question
        yesBtn: "Yes",                             // Yes button text
        noBtn: "No",                               // No button text
        secretAnswer: "Jag gillar inte dig, Jag älskar dig! ❤️"  // Hidden message
    },
    second: {
        text: "Hur mycket älskar du mig?",          // Second question
        startText: "This much!",                   // Text before percentage
        nextBtn: "Nästa ❤️"                         // Next button text
    },
    third: {
        text: "Vill du vara min Valentine...?",      // Final question
        yesBtn: "Ja!",                            // Yes button text
        noBtn: "Nej"                                // No button text
    }
}

// Love Meter Messages
loveMessages: {
    extreme: "WOOOOW älskar du mig så mycket? 🥰🚀💝",  // Shows above 5000%
...
// Final Celebration
celebration: {
    title: "Yay! Jag är den lyckligaste människan i världen...",     // Celebration title
    message: "kom nu och ta din gåva...",          // Celebration message
